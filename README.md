# 👋 你好，我是 bilipeng (一坨man) 🌴

一名坐标湖南的**软件技术**，是一名**全栈开发爱好者**。我热衷于探索 AI 原生开发流（Vibcoding）和个人私有云（Home Lab）的构建。

---

### 🚀 个人画像
- 🎓 **教育现状**：湖南大众传媒/ 软件技术
- 💻 **硬件环境**：Intel i7-13700H | RTX 4060 | 32GB RAM | Windows 11 + WSL2 (Ubuntu)
- 🏠 **私有云**：Feiniu OS (FNOS) 深度用户，运行着 Docker、青龙面板、PanSou 等服务
- 🤖 **AI 偏好**：更倾向于使用 Online API Tokens 追求极致的响应速度与智力，深度定制 OpenClaw 插件中
